...
import { PricingApi } from './pricing/data/pricing-api.service';
import { PricingGateway } from './pricing/domain/pricing.gateway';
...
const CATALOG_PROVIDERS: Provider[] = [
  ...
  PricingApi,
  PricingFacade,
  { provide: PricingGateway, useExisting: PricingApi },
];
...
export const CATALOG_ROUTES: Routes = [
  {
    ...
    loadComponent: () =>
      import('./pricing/ui/pricing-page/pricing-page').then((module) => module.PricingPage),
  },
  {
